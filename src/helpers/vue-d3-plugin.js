      ...
      methods: _extends(
         ...
         */
          drawGrid: function drawGrid(cs) {
            if (this.chartData.grid && this.chartData.grid.enabled === true) {
              ...
              for (
                var i = this.header;
                i < (this.height - this.header) * 0.8;
                i += this.gridTicks
              ) {
                grid.y.push(i);
              }
              d3
                .select("#" + this.chartData.selector)
         ...
         */
          drawTitle: function drawTitle() {
            ...
            d3
              ...
              .attr(
                "y",
                this.titleHeight - this.titleHeight * 0.1 + this.subtitleHeight
              )
              .style("text-anchor", "middle")
         ...
         */
          setOverrides: function setOverrides(cs, overrides) {
            ...
            try {
              for (
                var _iterator = _getIterator(keys), _step;
         ...
         */
          generateLegend: function generateLegend(cs) {
            ...
            if (
              ...
              this.chartData.legends.enabled === true
            ) {
              cs.palette.lineFill = Array.isArray(cs.palette.lineFill)
                ? cs.palette.lineFill
                : new Array(cs.palette.lineFill);
              cs.palette.fill = Array.isArray(cs.palette.fill)
                ? cs.palette.fill
                : new Array(cs.palette.fill);
              this.metric.forEach(function(e, i) {
                d3
                  .select("#" + _this.chartData.selector)
                  .append("text")
                  .attr("font-size", "10")
                  .attr("x", _this.width - 60)
                  .attr("y", _this.height * 0.95 - i * 15)
                  .style("text-anchor", "middle")
                  .text(_this.metric[i]);
                ...
                d3
                  ...
                  .attr("class", "legends")
                  .append("rect")
                  .attr("x", _this.width - 30)
                  .attr("y", _this.height * 0.95 - i * 15 - 10)
                  .attr("width", 30)
                  .attr("height", 10)
                  .style("fill", function() {
         ...
         */
          generateAxisLabels: function generateAxisLabels(cs) {
            var footer = this.chartData.legends ? 0.85 : 0.95;
        ...
        typeof bubbleChart !== "undefined" && { bubbleChart: bubbleChart }
      ),
      computed: {
        /**
        ...
        metric: function metric() {
          var metric = Array.isArray(this.chartData.metric)
        ...
        subtitleHeight: function subtitleHeight() {
          if (this.chartData.subtitle)
            return this.chartData.textHeight * 0.66 || 25 * 0.66;
          return 0;
        },
